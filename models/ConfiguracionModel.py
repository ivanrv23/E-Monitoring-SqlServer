...
# No importamos pyodbc explícitamente aquí porque se maneja en Connection, 
# pero capturamos Exception genérico como solicitado.
...
class ConfiguracionModel:
    ...
    def mdlObtenerConfiguracionEje(idproyecto, modulo, tipo):
        ...
        try:
            ...
            if resultado:
                # Convertir pyodbc.Row a tuple para compatibilidad con frontend
    ...
    def mdlRegistrarActualizarAjustesVisor(datos, existe):
        ...
        try:
            ...
            if existe:
                ...
                valoresupdate = [datos['colorfondo'], datos['tamaniotexto'], datos['colortexto'], datos['tamanioprisma'], datos['colorprisma'],
                ...
                # En SQL Server la sintaxis UPDATE es estándar, join de strings es seguro aquí
                ...
                valoresinsert = [datos['idproyecto'], datos['colorfondo'], datos['tamaniotexto'], datos['colortexto'],
                ...
                # Pyodbc requiere '?' por cada valor. La lógica original se mantiene.
